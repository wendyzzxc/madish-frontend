<template>
    <div class="dashboard">
        <v-navigation-drawer v-model="drawer" class="fullheight" width="256" app>
            <v-list-item>
                <v-list-item-content>
                    <v-list-item-title class="title"> Welcome {{ name }} </v-list-item-title>
                    <v-list-item-subtitle> Madish Restaurant </v-list-item-subtitle>
                </v-list-item-content>
            </v-list-item>
    ...
    export default {
        ...
        data() {
            return {
                ...
                drawer: true,
                items: [
                    { title: "Profile", to: '/Cprofil' },
                    { title: 'Reservation', to: '/Creservation' },
                    { title: 'Menu', to: '/Cmenu' },
                ],
            };
        },
